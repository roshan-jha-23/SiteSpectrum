...
export function FeatureCard2() {
  ...
  return (
    <div className="relative h-[24rem] w-full max-w-[32rem] max-h-[32rem] transform-gpu rounded-lg border bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] md:max-h-[500px]">
      <motion.div
      ...
      >
        <div className="flex h-full w-full items-center justify-center rounded-t-xl">
          <motion.div className="flex h-[300px] w-full cursor-pointer flex-col gap-y-5 overflow-hidden rounded-t-md p-5">
        ...
        <div className="flex w-full flex-col items-start border-t border-neutral-200 p-4 dark:border-neutral-800 h-[300px]">
          <h2 className="text-xl font-semibold">Fully Managed</h2>
          <p className="text-base font-normal text-neutral-500 dark:text-neutral-400">
            Our team of experts will handle everything for you.
          </p>
        </div>
      </motion.div>
    </div>
